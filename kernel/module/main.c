 ...
 */
  ...
  * charging. This section intercepts and patches MCA module behavior at load
  * time to improve bypass charging performance.
  *
  * To ensure stability across firmware updates and different devices, this
  * implementation relies on a firmware profile lookup table. Hardcoded
